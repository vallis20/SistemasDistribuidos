...
public class Progreso implements Remote, Serializable {
    ...
    // here are stored the IDs of the peers with which you have a connection
    private int[] connection; 
    // indicates whether the file is complete, in order to avoid comparing one by one the between the local client and the remote client
    ...
    // obtains the index of the first piece without downloading, under the condition that the remote client has it
    public synchronized int getIndexPieceNull(Progreso p){
