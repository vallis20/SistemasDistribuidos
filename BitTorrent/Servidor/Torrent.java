...
public class Torrent implements Serializable,Remote{
    ...
    private String name; // Name of the torrent
    private final int pieceLength=524288; // Length of each piece in Bytes (512KB)
    private int pieces; // Number of pieces
    private long length; // Total length of the file in bytes
    private ArrayList<Integer> seeders; // List of peers who have the complete file
    private ArrayList<Integer> leechers; // List of peers who are downloading the file
    ...
    // Parameterized constructor for creating a Torrent with specific details
